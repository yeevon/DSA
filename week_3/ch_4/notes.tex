...
\title{CS 300 -- Chapter 4 Notes\\\large Lists, Stacks, and Queues}
\author{Jose de Lima}
\date{\today}
...
do have a different implementation on each list flavor.
...
\texttt{cheat\_sheets/ch\_4.tex} (includes the decision matrix in compact
form). Practice prompts (problem $\to$ pseudocode $\to$ C++):
\texttt{practice\_prompts/ch\_4.md}.
