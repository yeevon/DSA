...
\title{CS 300 -- Chapter 5 Notes\\\large Hash Tables}
\author{Jose de Lima}
\date{\today}
...
\section{5.10 \textit{(next section -- ready to scrape)}}
...
\texttt{cheat\_sheets/ch\_5.tex}. Practice prompts (problem $\to$
pseudocode $\to$ C++): \texttt{practice\_prompts/ch\_5.md}.
