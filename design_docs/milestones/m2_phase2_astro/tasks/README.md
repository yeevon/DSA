...
| T6  | [Replace GitHub Pages workflow](T6_pages_workflow.md)             | ✅ done 2026-04-23 | T1, T3, T4, T5b | < 1 session |
| T7  | [Resolve `phase2_issues.md` items](T7_phase2_issues_cleanup.md)   | ✅ done 2026-04-23 | T2 (or T4) | < 1 session |
| T8  | [Delete Jekyll scaffolding](T8_delete_jekyll.md)                  | ✅ done 2026-04-23 | T6 (one green cycle) | < 1 session |
