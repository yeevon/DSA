...
| M4    | [Phase 4 — Question generation](m4_phase4_question_gen/README.md)   | todo (upstream-gated, see [`../../aiw_workflow_discovery_issue.md`](../../aiw_workflow_discovery_issue.md)) | M5 |
