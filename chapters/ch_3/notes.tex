...
\title{Ch.~3 Notes\\\large Data Structures, Big-O, Sorting}
\author{}
\date{}
...
Bucket$^\dagger$     & $n$               & $n$               & $n^2$             & yes             & no
\end{tabular}

\smallskip
$^\ast$Bubble sort is covered in ch\_13.1 (extras) — pedagogy-only,
never ship it. $^\dagger$Bucket-sort average $O(n)$ assumes input is
uniformly distributed; full treatment in ch\_13.3.
